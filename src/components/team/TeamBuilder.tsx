            ...
            {activeTab === "volgende" && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <button onClick={handleDownloadImage} disabled={downloading} className={BTN_SECONDARY + " w-full"}>
                ...
                {!readOnly && (
                  <div className="pt-2 border-t border-green-500/20">
                    <button onClick={handleUnlock} disabled={unlocking} className={BTN_SECONDARY + " w-full text-red-400 hover:text-red-300 hover:border-red-500/30 border-red-500/20"}>
              ...
              <div>
                {!hasPrediction && !readOnly && (
                  <div className="space-y-3">
                    ...
                    <button onClick={() => setShowPredictionModal(true)} className={BTN_PRIMARY + " w-full"}>
